...
import { TimeEntry, Project, SelectedClientData } from '@/app/types/globalTypes';
...
export default function TimeTrackedList({
  ...
  showPastInvoicesByDefault = true,
  loadStyle = 'byWeeks',
...
/>
        ...
        <td>
          {entry.invoice_id ? (
            <Link href={`/invoices/${entry.invoice_id}`} className='flex-center-center flex-column no-flex-grow'>
