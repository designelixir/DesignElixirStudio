...
import { fetchInvoicesAction } from '@/app/admin/actions/invoiceActions';
          ...
          return (
            ...
            >
              ...
              <div className='client-tag-wrapper' style={{backgroundColor: 'unset', }}>
                ...
                <p className='no-text-spacing'><Link href={`/admin/client-list/${invoice.client_id}`}>{invoice.client_first} {invoice.client_last} </Link> - <strong>{invoice.project_name}</strong></p>
              </div>
            </div>
                </td>
